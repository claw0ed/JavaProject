...
//		}
		...
		while(true) {
			...
			switch(job) {
			case "c": System.out.println("<회원등록 메뉴를 선택>"); break;
			case "r": System.out.println("<회원조회 메뉴를 선택>"); break;
			case "u": System.out.println("<회원수정 메뉴를 선택>"); break;
			case "d": System.out.println("<회원삭제 메뉴를 선택>"); break;
